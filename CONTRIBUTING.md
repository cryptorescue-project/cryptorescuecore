Contributing to CryptoRescueCore
=======

Thanks to the Ravencoin community for releasing this amazing javascript based library to be able to fork CPR with. Their hard work is not going to be wasted! CPR is currently undergoing a fork of the RVN community efforts to further the x16s community.
...
These are some global design goals in cryptorescuecore that any change must adhere.
...
When possible, cryptorescuecore objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of CryptoRescueCored methods. For example, calling `JSON.stringify` on an CryptoRescueCore object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### E1 - Use cryptorescuecore.Errors
...
#### T3 - Require 'cryptorescuecore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the cryptorescuecore object.
...
```sh
git remote add under git@github.com:cryptorescue-project/cryptorescuecore.git
...
```
Finally go to [github.com/cryptorescue-project/cryptorescuecore](https://github.com/cryptorescue-project/cryptorescuecore) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of cryptorescuecore.

If you have any questions feel free to post them to
[github.com/cryptorescue-project/cryptorescuecore/issues](https://github.com/cryptorescue-project/cryptorescuecored/issues).
